...
def main(args):
    ...
    for sc in scenes:
        os.system(f'python3 bin/predict.py model.path=$(pwd)/big-lama indir={args.root_dir}/{sc}/lama_depth_input{args.suffix} outdir={args.root_dir}/{sc}/lama_depth_output{args.suffix} dataset.rotate={rotate} dataset.resize={resize}')
