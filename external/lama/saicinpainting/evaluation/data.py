...
class InpaintingDataset(Dataset):
    def __init__(self, datadir, img_suffix='.jpg', pad_out_to_modulo=None, scale_factor=None, rotate=False, resize=False):
    ...
    def __getitem__(self, i):
        ...
        if self.resize:
            ...
            image = cv2.resize(image, (256, 192)).transpose((-1, 0, 1))
